      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Value 1 */}
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 border-t-4 border-[#3498db]">
            ...
            {/* Value 2 */}
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 border-t-4 border-[#e74c3c]">
            ...
            {/* Value 3 */}
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 border-t-4 border-[#2ecc71]">
        ...
        <div className="max-w-4xl mx-auto mt-20">
          <div className="bg-gradient-to-r from-[#2c3e50] to-[#3498db] rounded-xl p-8 md:p-12 text-white">
            ...
            <Link
              to="/contact"
              className="inline-block bg-white text-[#2c3e50] px-6 py-3 rounded-lg font-medium hover:bg-gray-100 transition duration-300"
            >
              Partner With Us
            </Link>
          </div>
